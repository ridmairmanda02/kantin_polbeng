...
<div class="container-fluid pt-3 pb-5 backGambar">
  <div class="row mt-3">
    <div class="col-xl-8 table-responsive">
      <a href="cetak-laporan-member-mahasiswa.php" class="btn btn-sm btn-success text-white mb-3" target="_blank">&nbsp;<i class="fas fa-print"></i>&nbsp;&nbsp;Member Mahasiswa&nbsp;&nbsp;</a>

      <table class="table table-bordered table-hover" id="laporanMahasiswa">
        <thead>
