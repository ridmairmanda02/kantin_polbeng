  ...
  <body>
    ...
    if($id_login==""){?>
      ...
      <div class="jumbotron text-center">
        ...
        <h1 class="textWarning">Kantin PoLbeng</h1>
        <p class="kopi">Kantinnya Politeknik Negeri Bengkalis </p>
      </div>
      <!-- Akhir Jumbtron -->
      <?php 
    }?>
    ...
    if($id_login==""){?>
      ...
      <section class="about" id="about">
        <div class="container-fluid imgAbout">
          ...
          <div class="row mt-3">
            <div class="col-md-6">
              <p class="pKiri">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kantin menjadi salah satu area di kampus yang patut mendapatkan perhatian khusus. Tidak sekadar menjual makanan minuman yang lezat, kehadiran kantin harus dipastikan menyediakan makanan dan minuman yang sehat, baik makanan utama yang bergizi seimbang atau makanan selingan. <br>
              
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Terdapat empat pilar yang menyokong terwujudnya kantin polbeng yaitu komitmen dan manajemen kkampus; sumber daya manusia; sarana prasarana; dan mutu pangan. Pembinaan kantin polbeng tidak hanya melibatkan para pedagang namun juga mahasiswa.<br>
              
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Untuk mewujudkan kantin polbeng, satuan pendidikan dapat melaksanakan sejumlah kegiatan seperti mengadakan penyuluhan  higiene sanitasi pangan dan  penyuluhan makanan bergizi seimbang untuk food handler.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <p class="footer">Kelompok 8 <?= date('Y'); ?> | POLITEKNIK NEGERI BENGKALIS</p>
          </div>
        </div>
      </div>
    </footer>
